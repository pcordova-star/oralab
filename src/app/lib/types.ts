...
export const PROTOCOLS: Record<string, ExamProtocol> = {
  SIBO: {
    ...
    steps: [
      ...
      { name: 'Espera Muestra 4', type: 'wait', durationMinutes: 30, description: 'Mantenga reposo absoluto.' },
  ...
  Lactulosa: {
    ...
    steps: [
      ...
      { name: 'Muestra 3 (T-60)', type: 'breath', durationMinutes: 0, description: 'Sople en el tercer tubo.' },
      { name: 'Espera Muestra 4', type: 'wait', durationMinutes: 30, description: 'Reposo absoluto.' },
      { name: 'Muestra 4 (T-90)', type: 'breath', durationMinutes: 0, description: 'Sople en el cuarto tubo.' },
      { name: 'Espera Muestra 5', type: 'wait', durationMinutes: 30, description: 'Reposo absoluto.' },
      { name: 'Muestra 5 (T-120)', type: 'breath', durationMinutes: 0, description: 'Sople en el quinto tubo.' },
      { name: 'Espera Muestra 6', type: 'wait', durationMinutes: 30, description: 'Reposo absoluto.' },
      { name: 'Muestra 6 (T-150)', type: 'breath', durationMinutes: 0, description: 'Sople en el sexto tubo.' },
      { name: 'Espera Muestra 7', type: 'wait', durationMinutes: 30, description: 'Reposo absoluto.' },
      { name: 'Muestra 7 (T-180)', type: 'breath', durationMinutes: 0, description: 'Sople en el último tubo.' },
    ]
  },
  Fructosa: {
    id: 'Fructosa',
