...
export const PROTOCOLS: Record<string, ExamProtocol> = {
  SIBO: {
    ...
    instructions: 'Protocolo optimizado para detección de sobrecrecimiento bacteriano con 4 muestras.',
    steps: [
  ...
  Lactulosa: {
    id: 'Lactulosa',
    name: 'Test de Lactulosa (Protocolo 120 min)',
    instructions: 'Este test evalúa el sobrecrecimiento bacteriano con una curva detallada de 7 muestras.',
    steps: [
      ...
      { name: 'Espera Muestra 1', type: 'wait', durationMinutes: 15, description: 'Reposo absoluto. No coma ni beba.' },
  ...
  Fructosa: {
    id: 'Fructosa',
    name: 'Test de Fructosa (Protocolo 120 min)',
    instructions: 'Evalúa malabsorción de fructosa con un seguimiento de 7 muestras.',
    steps: [
      ...
      { name: 'Espera Muestra 1', type: 'wait', durationMinutes: 15, description: 'Reposo absoluto.' },
      { name: 'Muestra 2 (T-20)', type: 'breath', durationMinutes: 0, description: 'Sople en el segundo tubo.' },
      { name: 'Espera Muestra 2', type: 'wait', durationMinutes: 20, description: 'Reposo absoluto.' },
      { name: 'Muestra 3 (T-40)', type: 'breath', durationMinutes: 0, description: 'Sople en el tercer tubo.' },
      { name: 'Espera Muestra 3', type: 'wait', durationMinutes: 20, description: 'Reposo absoluto.' },
  ...
  Lactosa: {
    id: 'Lactosa',
    name: 'Test de Lactosa (Protocolo 120 min)',
    instructions: 'Evalúa intolerancia a la lactosa con un seguimiento de 7 muestras.',
    steps: [
      { name: 'Muestra Basal (T-0)', type: 'breath', durationMinutes: 0, description: 'Sople en el primer tubo.' },
