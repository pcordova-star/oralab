              ...
              <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100 flex items-start gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-amber-800/80 leading-relaxed font-medium">
                    Completa tus datos para formalizar digitalmente. Basta con la <strong>Firma Electrónica Simple (FES)</strong>. El Representante Legal firmará con <strong>Firma Electrónica Avanzada (FEA)</strong> en una plataforma externa.
                  </p>
                </div>
              </div>
